...
/**
 * CenterPanel - Responsive main content area component with conversation list
 */
export function CenterPanel({ children, mobile = false }: CenterPanelProps) {
      ...
      <header className="border-b border-border bg-card px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <p className="text-xs sm:text-sm text-muted-foreground">GLOBAL WORKSPACE</p>
